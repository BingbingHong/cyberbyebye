...
export default function OfferingStage({ onComplete }: OfferingStageProps) {
  ...
  return (
    <div className="relative w-[1440px] h-[1024px] bg-transparent overflow-hidden" data-name="Desktop - 5">
      <motion.div 
      ...
      {!allRevealed && (
        <p className="absolute leading-[normal] left-1/2 -translate-x-1/2 not-italic text-[28px] text-black text-nowrap top-[847px] tracking-[0.84px] animate-pulse">
          "后生仔，虔诚的摆上贡品吧"
        </p>
      )}
