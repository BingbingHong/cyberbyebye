...
import img1 from "figma:asset/60a8afc0196f1635ab39f4278b7224f5262f626a.png";
import img2 from "figma:asset/8ce5b717cbc407631b6a64054263490b5b3f85ac.png";
    ...
    <div className="absolute contents left-[572px] top-[569px]">
      ...
      <div className="absolute h-[248px] left-[calc(50%-0.5px)] top-[598px] translate-x-[-50%] w-[295px]" data-name="炉子 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[344.76%] left-[-64.41%] max-w-none top-[-210.48%] w-[223.39%]" src={img1} />
        </div>
      </div>
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="relative size-full" data-name="Desktop - 7" style={{ backgroundImage: "linear-gradient(rgba(251, 196, 212, 0) 9.668%, rgb(251, 196, 212) 114.31%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
